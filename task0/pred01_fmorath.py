...
df_train = pd.read_csv('/Users/florianmorath/Desktop/Python/task0/task0_sl19d9/train.csv')
df_test = pd.read_csv('/Users/florianmorath/Desktop/Python/task0/task0_sl19d9/test.csv')
