...
param_grid = {
#   'svc__gamma': np.linspace(0.008, 0.009, 100),
#   'svc__C': np.linspace(1,3,100)
}
clf = svm.SVC(kernel = 'rbf', gamma = 0.0085175175175175172, C = 2.191919191919192)
...
# print('available parameters = ', sel_clf.get_params().keys())
