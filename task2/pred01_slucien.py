...
#clf = neighbors.KNeighborsClassifier(n_neighbors = 12,weights='distance', algorithm = 'auto', p =1)
#clf = OneVsRestClassifier(LinearSVC(random_state=0))
#clf= OneVsOneClassifier(LinearSVC(random_state=0))
clf = svm.SVC(kernel = 'poly', gamma = 0.0085175175175175172, C = 2.191919191919192, decision_function_shape='ovr')
